...
- Add the [URL](https://github.com/Julian0021/fronius_modbus) to the repository.
...
| Charge from AC   | Web API toggle for `HYB_BM_CHARGEFROMAC`. Turning it off disables both charge-source flags.                                                                                                                                                                                                                                |
| Charge from grid | Web API toggle for `HYB_EVU_CHARGEFROMGRID`. Turning it on also enables `Charge from AC`. Turning it off only disables the grid flag.                                                                                                                                                                                     |
